...
/** Grouped bars + dotted trend line in the warm palette, like the
  ...
  return (
    <ResponsiveContainer width="100%" height={height}>
      <ComposedChart data={data} barGap={2}>
        ...
        />
        <Tooltip
          cursor={{ fill: "rgba(245, 184, 41, 0.08)" }}
          contentStyle={{
            borderRadius: 14,
            border: "none",
            boxShadow: "0 8px 24px rgb(23 21 15 / 0.12)",
            fontSize: 13,
          }}
        />
